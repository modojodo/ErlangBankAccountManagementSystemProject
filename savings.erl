...
-include("records.hrl").
init_savings()->
ets:new(savings,[named_table,set,{keypos, #account.cnic}]).
...
accounts:check_status(ets:insert(savings, #account{cnic=Id_ex, name=Full, address=Address_ex, date=date() , time=time() })),
